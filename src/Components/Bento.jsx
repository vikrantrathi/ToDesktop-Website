    ...
    <div>
      <section className="mt-20 w-full px-10">
        <div className="max-w-7xl container mx-auto">
          <h2 className="text-5xl font-bold lg:w-[40%]">
            ToDesktop handles the details
          </h2>
        </div>
        <div
          className="flex flex-col lg:grid lg:grid-cols-3 gap-6 mt-10 max-w-7xl container mx-auto "
        ...
        >
          ...
          <div className="row-start-1 row-end-4 rounded-2xl hover:bg-gradient-to-br hover:from-red-200 hover:via-purple-200 hover:to-yellow-200 bg-slate-50  p-[2px] group">
            <div className="rounded-2xl bg-slate-50 w-full h-full flex flex-col items-center p-6 group-hover:bg-gradient-to-br group-hover:from-red-50 group-hover:via-purple-50 group-hover:to-yellow-50 gap-4">
              <h3 className="text-2xl font-medium">Native Notification</h3>
